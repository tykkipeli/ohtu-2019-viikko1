...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        joujoujou(mehua,olutta);
        jeajeajea(mehua,olutta);
        ...
        System.out.println("Olutvarasto: " + olutta); System.out.println("Mehuvarasto: " + mehua); System.out.println("mehua.otaVarastosta(-32.9)");
        saatiin = mehua.otaVarastosta(-32.9);
        System.out.println("saatiin " + saatiin);
        System.out.println("Mehuvarasto: " + mehua);
        System.out.println("Hiphei");
        System.out.println("Hiphei");
        System.out.println("Hiphei");
        System.out.println("Hiphei");
        System.out.println("Hiphei");
    ...
    private static void joujoujou(Varasto mehua, Varasto olutta) {
        ...
        System.out.println("Lisätään 50.7"); mehua.lisaaVarastoon(50.7);
        System.out.println("Mehuvarasto: " + mehua); System.out.println("Otetaan 3.14");
        mehua.otaVarastosta(3.14);
        System.out.println("Mehuvarasto: " + mehua);
    }

    private static void jeajeajea(Varasto mehua, Varasto olutta) {
        ...
        System.out.println("Olutvarasto: " + olutta); System.out.println("Mehuvarasto: " + mehua); System.out.println("mehua.lisaaVarastoon(-666.0)");
